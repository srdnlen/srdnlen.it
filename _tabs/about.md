...
<div class="card h-50 mb-3">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-2">
                <img src="../assets/img/avatars/lollo.png" alt="avatar">
            </div>
            <div class="col-10">
...
<div class="card h-50 mb-3">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-2">
                <img src="../assets/img/avatars/pc98.png" alt="avatar">
            </div>
            <div class="col-10">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-10">
                ...
                <p class="card-text">
                    High School: Liceo scientifico delle scienze applicate M. Giua <br>
                    Bachelor's degree: Computer Science at UNICA <br>
